...
export type GameOptionsActionId = "pause-1" | "restart-2";
...
export function GameOptions({ actions }: GameOptionsProps) {
  return (
    <>
      <header>
          <div><div className="meta">Pulse Grid PRD</div><h1>Game Options</h1><p>Task-requested settings such as audio, difficulty, speed, controls, or preferences.</p></div>
